                ...
                >
                  <CardContent className="p-3 flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-xs text-black/60">{c.channelId}</div>
                    </div>
                  </CardContent>
                </Card>
              ))}
        ...
        <CardContent>
          {loading ? (
            <div className="min-h-[50vh] flex items-center justify-center">
              <LoadingPage message="Loading Thumbnails..." fullScreen={false} />
            </div>
          ) : error ? (
                  ...
                  {previews.map((p) => (
                    ...
                    >
                      {p.url ? (
                        ...
                        <span className="text-xs text-black/60">Uploaded</span>
                      )}
                      {p.status === "finished" ? (
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    const images = previews
                      .filter((p) => p.status === "finished" && Boolean(p.url))
